...
public class NetworkStateView extends LinearLayout {
    ...
    public NetworkStateView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        mTextSize = typedArray.getDimensionPixelSize(R.styleable.NetworkStateView_nsvTextSize, DensityUtil.dip2px(App.getContext(),14));

        typedArray.recycle();

        mInflater = LayoutInflater.from(context);
        params = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        setBackgroundColor(App.getContext().getResources().getColor(R.color.white));
    }
    ...
    public void showLoading() {
        ...
        lvNews =mLoadingView.findViewById(R.id.loading_news);
        lvNews.setViewColor(Color.parseColor("#06c2ad"));
        lvNews.startAnim();
        showViewByState(mCurrentState);
    }
