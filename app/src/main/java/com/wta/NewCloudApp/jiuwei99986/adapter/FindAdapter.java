...
public class FindAdapter extends BaseQuickAdapter<FindData.DataEntity, BaseViewHolder> {
    ...
    public FindAdapter(@LayoutRes int layoutResId, @Nullable List<FindData.DataEntity> data, Context context ) {
    ...
    @Override
    protected void convert(BaseViewHolder helper, FindData.DataEntity item) {
