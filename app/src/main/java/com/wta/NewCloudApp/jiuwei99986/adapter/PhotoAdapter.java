...
public class PhotoAdapter extends RecyclerView.Adapter<PhotoAdapter.PhotoViewHolder> {
    ...
    public PhotoAdapter(Context mContext, ArrayList<String> photoPaths, OnItemSelectListener onItemSelectListener) {
    ...
    public PhotoViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_ADD:
                itemView = inflater.inflate(com.wta.NewCloudApp.jiuwei99986.R.layout.item_add, parent, false);
                break;
            case TYPE_PHOTO:
